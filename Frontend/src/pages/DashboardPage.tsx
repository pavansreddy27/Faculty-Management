...
import { Users, BookOpen, Building2, FileText, TrendingUp, Calendar, Clock } from 'lucide-react'; // Import Clock icon
import { Link } from 'react-router-dom';
import { facultyService, departmentService, courseService } from '../api/services';
...
const DashboardPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const [facultyRes, departmentRes, courseRes] = await Promise.all([
  ...
  const quickActions = [
    ...
    // New Quick Action for Faculty Timetable
    {
      title: 'View My Timetable',
      description: 'Check your scheduled classes and office hours',
      icon: Clock, // Using the Clock icon from lucide-react
      link: '/timetable', // You will need to create this route and component
      roles: ['FACULTY'], // Only faculty can see this
    },
  ];
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-indigo-100 text-lg">
              ...
              {hasRole('FACULTY') && 'Access your profile and timetable'} {/* Updated description for faculty */}
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-gray-600">
            ...
            <p>
              Currently managing {stats.totalCourses} courses .
            </p>
          </div>
        </CardContent>
      </Card>
